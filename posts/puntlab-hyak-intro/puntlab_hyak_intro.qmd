...
**NOTE**: This information was accurate as of early 2020, but is now (April
  2022) slightly out of date; e.g. the `klone` cluster is now available and
  interactive nodes are no longer a separate partition.
...
## Example: Simulation study {#example-simulation-study-fig}

![Simulation study flow chart](simstudy.png)
...
![Choosing a node type](nodechoice.png)
...
- [Driver script](www/fitsims.R)
- [SLURM script](www/fitsims.slurm)
...
-   Set up `sshfs`
-   [Compile your own R with MKL](/posts/compiling-r-with-mkl-on-hyak/compiling-r-with-intel-compilers-and-mkl-on-hyak.qmd)
